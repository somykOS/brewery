...
public record CookingData(double time, List<ItemStack> ingredients, Block heatSource) {
    ...
    public static final CookingData DEFAULT = new CookingData(0, List.of(), Blocks.AIR);
}
